...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1326   Config drift guard + queue-drain + host normalization
  L2008   Ollama num_ctx, host failover, per-host models, machines
  L2416   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3714   Session lifecycle: autosave, snapshots, statusline
  L3983   Composer: input buffer, queue, paste/key parsing
  L4540   Version/update precedence + provider registration API
  L5201   Session modes + CLI arg completion + /set + leash + per-model
  L5685   Grouped lean-tools + provider/tool discovery dirs
  L5978   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
