...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2609   Ollama num_ctx, host failover, per-host models, machines
  L3017   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4334   Session lifecycle: autosave, snapshots, statusline
  L4603   Composer: input buffer, queue, paste/key parsing
  L5160   Version/update precedence + provider registration API
  L5821   Session modes + CLI arg completion + /set + leash + per-model
  L6305   Grouped lean-tools + provider/tool discovery dirs
  L6598   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
