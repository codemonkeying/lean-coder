...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2121   Config drift guard + queue-drain + host normalization
  L3014   Ollama num_ctx, host failover, per-host models, machines
  L3436   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4777   Session lifecycle: autosave, snapshots, statusline
  L5068   Composer: input buffer, queue, paste/key parsing
  L5658   Version/update precedence + provider registration API
  L6328   Session modes + CLI arg completion + /set + leash + per-model
  L6815   Grouped lean-tools + provider/tool discovery dirs
  L7121   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
