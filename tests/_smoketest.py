...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L4315   Session lifecycle: autosave, snapshots, statusline
  L4584   Composer: input buffer, queue, paste/key parsing
  L5141   Version/update precedence + provider registration API
  L5802   Session modes + CLI arg completion + /set + leash + per-model
  L6286   Grouped lean-tools + provider/tool discovery dirs
  L6579   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
