...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1685   Config drift guard + queue-drain + host normalization
  L2396   Ollama num_ctx, host failover, per-host models, machines
  L2804   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4102   Session lifecycle: autosave, snapshots, statusline
  L4371   Composer: input buffer, queue, paste/key parsing
  L4928   Version/update precedence + provider registration API
  L5589   Session modes + CLI arg completion + /set + leash + per-model
  L6073   Grouped lean-tools + provider/tool discovery dirs
  L6366   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
