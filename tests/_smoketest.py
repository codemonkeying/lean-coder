...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5142   Session lifecycle: autosave, snapshots, statusline
  L5474   Composer: input buffer, queue, paste/key parsing
  L6083   Version/update precedence + provider registration API
  L6758   Session modes + CLI arg completion + /set + leash + per-model
  L7245   Grouped lean-tools + provider/tool discovery dirs
  L7549   Per-process run dirs (liveness reaper, no age)
  L7579   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
