...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L4803   Session lifecycle: autosave, snapshots, statusline
  L5122   Composer: input buffer, queue, paste/key parsing
  L5731   Version/update precedence + provider registration API
  L6401   Session modes + CLI arg completion + /set + leash + per-model
  L6888   Grouped lean-tools + provider/tool discovery dirs
  L7194   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
