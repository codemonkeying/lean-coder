...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2520   Ollama num_ctx, host failover, per-host models, machines
  L2928   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4226   Session lifecycle: autosave, snapshots, statusline
  L4495   Composer: input buffer, queue, paste/key parsing
  L5052   Version/update precedence + provider registration API
  L5713   Session modes + CLI arg completion + /set + leash + per-model
  L6197   Grouped lean-tools + provider/tool discovery dirs
  L6490   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
