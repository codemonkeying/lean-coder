...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1198   Config drift guard + queue-drain + host normalization
  L1879   Ollama num_ctx, host failover, per-host models, machines
  L2287   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3585   Session lifecycle: autosave, snapshots, statusline
  L3854   Composer: input buffer, queue, paste/key parsing
  L4411   Version/update precedence + provider registration API
  L5072   Session modes + CLI arg completion + /set + leash + per-model
  L5556   Grouped lean-tools + provider/tool discovery dirs
  L5849   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
