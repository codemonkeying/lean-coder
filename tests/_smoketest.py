...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2511   Ollama num_ctx, host failover, per-host models, machines
  L2919   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4217   Session lifecycle: autosave, snapshots, statusline
  L4486   Composer: input buffer, queue, paste/key parsing
  L5043   Version/update precedence + provider registration API
  L5704   Session modes + CLI arg completion + /set + leash + per-model
  L6188   Grouped lean-tools + provider/tool discovery dirs
  L6481   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
