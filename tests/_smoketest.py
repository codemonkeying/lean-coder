...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2098   Config drift guard + queue-drain + host normalization
  L2991   Ollama num_ctx, host failover, per-host models, machines
  L3413   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4754   Session lifecycle: autosave, snapshots, statusline
  L5023   Composer: input buffer, queue, paste/key parsing
  L5585   Version/update precedence + provider registration API
  L6255   Session modes + CLI arg completion + /set + leash + per-model
  L6742   Grouped lean-tools + provider/tool discovery dirs
  L7048   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
