...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2099   Config drift guard + queue-drain + host normalization
  L2992   Ollama num_ctx, host failover, per-host models, machines
  L3414   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4755   Session lifecycle: autosave, snapshots, statusline
  L5024   Composer: input buffer, queue, paste/key parsing
  L5614   Version/update precedence + provider registration API
  L6284   Session modes + CLI arg completion + /set + leash + per-model
  L6771   Grouped lean-tools + provider/tool discovery dirs
  L7077   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
