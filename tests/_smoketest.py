...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1462   Config drift guard + queue-drain + host normalization
  L2173   Ollama num_ctx, host failover, per-host models, machines
  L2581   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3879   Session lifecycle: autosave, snapshots, statusline
  L4148   Composer: input buffer, queue, paste/key parsing
  L4705   Version/update precedence + provider registration API
  L5366   Session modes + CLI arg completion + /set + leash + per-model
  L5850   Grouped lean-tools + provider/tool discovery dirs
  L6143   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
