...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2369   Config drift guard + queue-drain + host normalization
  L3388   Ollama num_ctx, host failover, per-host models, machines
  L3810   Remote executor + SSH transport + RemoteWorkspace + Windows
  L5201   Session lifecycle: autosave, snapshots, statusline
  L5533   Composer: input buffer, queue, paste/key parsing
  L6142   Version/update precedence + provider registration API
  L6817   Session modes + CLI arg completion + /set + leash + per-model
  L7304   Grouped lean-tools + provider/tool discovery dirs
  L7608   Per-process run dirs (liveness reaper, no age)
  L7638   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
