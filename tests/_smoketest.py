...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L310    Core tool bodies (ignore, diff parser, read/write/apply, search, run_command)
  L1840   Config drift guard + queue-drain + host normalization
  L2732   Ollama num_ctx, host failover, per-host models, machines
  L3140   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4479   Session lifecycle: autosave, snapshots, statusline
  L4748   Composer: input buffer, queue, paste/key parsing
  L5310   Version/update precedence + provider registration API
  L5971   Session modes + CLI arg completion + /set + leash + per-model
  L6458   Grouped lean-tools + provider/tool discovery dirs
  L6764   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
