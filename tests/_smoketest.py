...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L303    Core tool bodies (ignore, diff parser, read/write/apply, search, run_command)
  L1808   Config drift guard + queue-drain + host normalization
  L2699   Ollama num_ctx, host failover, per-host models, machines
  L3107   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4446   Session lifecycle: autosave, snapshots, statusline
  L4715   Composer: input buffer, queue, paste/key parsing
  L5277   Version/update precedence + provider registration API
  L5938   Session modes + CLI arg completion + /set + leash + per-model
  L6425   Grouped lean-tools + provider/tool discovery dirs
  L6731   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
