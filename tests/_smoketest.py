...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L415    Core tool bodies (ignore, diff parser, read/write/apply, search, run_command)
  L2093   Config drift guard + queue-drain + host normalization
  L2986   Ollama num_ctx, host failover, per-host models, machines
  L3394   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4735   Session lifecycle: autosave, snapshots, statusline
  L5004   Composer: input buffer, queue, paste/key parsing
  L5566   Version/update precedence + provider registration API
  L6236   Session modes + CLI arg completion + /set + leash + per-model
  L6723   Grouped lean-tools + provider/tool discovery dirs
  L7029   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
