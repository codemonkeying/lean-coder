...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1823   Ollama num_ctx, host failover, per-host models, machines
  L2231   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3495   Session lifecycle: autosave, snapshots, statusline
  L3764   Composer: input buffer, queue, paste/key parsing
  L4321   Version/update precedence + provider registration API
  L4956   Session modes + CLI arg completion + /set + leash + per-model
  L5426   Grouped lean-tools + provider/tool discovery dirs
  L5698   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
