...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1754   Config drift guard + queue-drain + host normalization
  L2465   Ollama num_ctx, host failover, per-host models, machines
  L2873   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4171   Session lifecycle: autosave, snapshots, statusline
  L4440   Composer: input buffer, queue, paste/key parsing
  L4997   Version/update precedence + provider registration API
  L5658   Session modes + CLI arg completion + /set + leash + per-model
  L6142   Grouped lean-tools + provider/tool discovery dirs
  L6435   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
