...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2985   Ollama num_ctx, host failover, per-host models, machines
  L3393   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4732   Session lifecycle: autosave, snapshots, statusline
  L5001   Composer: input buffer, queue, paste/key parsing
  L5563   Version/update precedence + provider registration API
  L6224   Session modes + CLI arg completion + /set + leash + per-model
  L6711   Grouped lean-tools + provider/tool discovery dirs
  L7017   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
