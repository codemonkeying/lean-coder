...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1288   Config drift guard + queue-drain + host normalization
  L1970   Ollama num_ctx, host failover, per-host models, machines
  L2378   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3676   Session lifecycle: autosave, snapshots, statusline
  L3945   Composer: input buffer, queue, paste/key parsing
  L4502   Version/update precedence + provider registration API
  L5163   Session modes + CLI arg completion + /set + leash + per-model
  L5647   Grouped lean-tools + provider/tool discovery dirs
  L5940   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
