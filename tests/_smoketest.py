...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1180   Config drift guard + queue-drain + host normalization
  L1861   Ollama num_ctx, host failover, per-host models, machines
  L2269   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3567   Session lifecycle: autosave, snapshots, statusline
  L3836   Composer: input buffer, queue, paste/key parsing
  L4393   Version/update precedence + provider registration API
  L5054   Session modes + CLI arg completion + /set + leash + per-model
  L5538   Grouped lean-tools + provider/tool discovery dirs
  L5831   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
