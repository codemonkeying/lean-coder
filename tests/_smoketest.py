...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1426   Config drift guard + queue-drain + host normalization
  L2137   Ollama num_ctx, host failover, per-host models, machines
  L2545   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3843   Session lifecycle: autosave, snapshots, statusline
  L4112   Composer: input buffer, queue, paste/key parsing
  L4669   Version/update precedence + provider registration API
  L5330   Session modes + CLI arg completion + /set + leash + per-model
  L5814   Grouped lean-tools + provider/tool discovery dirs
  L6107   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
