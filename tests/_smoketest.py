...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1992   Config drift guard + queue-drain + host normalization
  L2884   Ollama num_ctx, host failover, per-host models, machines
  L3292   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4631   Session lifecycle: autosave, snapshots, statusline
  L4900   Composer: input buffer, queue, paste/key parsing
  L5462   Version/update precedence + provider registration API
  L6123   Session modes + CLI arg completion + /set + leash + per-model
  L6610   Grouped lean-tools + provider/tool discovery dirs
  L6916   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
