...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2116   Config drift guard + queue-drain + host normalization
  L3009   Ollama num_ctx, host failover, per-host models, machines
  L3431   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4772   Session lifecycle: autosave, snapshots, statusline
  L5063   Composer: input buffer, queue, paste/key parsing
  L5653   Version/update precedence + provider registration API
  L6323   Session modes + CLI arg completion + /set + leash + per-model
  L6810   Grouped lean-tools + provider/tool discovery dirs
  L7116   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
