...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1668   Config drift guard + queue-drain + host normalization
  L2379   Ollama num_ctx, host failover, per-host models, machines
  L2787   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4085   Session lifecycle: autosave, snapshots, statusline
  L4354   Composer: input buffer, queue, paste/key parsing
  L4911   Version/update precedence + provider registration API
  L5572   Session modes + CLI arg completion + /set + leash + per-model
  L6056   Grouped lean-tools + provider/tool discovery dirs
  L6349   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
