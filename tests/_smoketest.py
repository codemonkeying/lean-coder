...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2663   Ollama num_ctx, host failover, per-host models, machines
  L3071   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4410   Session lifecycle: autosave, snapshots, statusline
  L4679   Composer: input buffer, queue, paste/key parsing
  L5241   Version/update precedence + provider registration API
  L5902   Session modes + CLI arg completion + /set + leash + per-model
  L6389   Grouped lean-tools + provider/tool discovery dirs
  L6695   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
