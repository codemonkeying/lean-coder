...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1496   Config drift guard + queue-drain + host normalization
  L2207   Ollama num_ctx, host failover, per-host models, machines
  L2615   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3913   Session lifecycle: autosave, snapshots, statusline
  L4182   Composer: input buffer, queue, paste/key parsing
  L4739   Version/update precedence + provider registration API
  L5400   Session modes + CLI arg completion + /set + leash + per-model
  L5884   Grouped lean-tools + provider/tool discovery dirs
  L6177   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
