...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5036   Session modes + CLI arg completion + /set + leash + per-model
  L5520   Grouped lean-tools + provider/tool discovery dirs
  L5813   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
