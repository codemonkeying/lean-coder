...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2613   Ollama num_ctx, host failover, per-host models, machines
  L3021   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4338   Session lifecycle: autosave, snapshots, statusline
  L4607   Composer: input buffer, queue, paste/key parsing
  L5164   Version/update precedence + provider registration API
  L5825   Session modes + CLI arg completion + /set + leash + per-model
  L6309   Grouped lean-tools + provider/tool discovery dirs
  L6602   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
