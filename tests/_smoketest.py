...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1815   Config drift guard + queue-drain + host normalization
  L2706   Ollama num_ctx, host failover, per-host models, machines
  L3114   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4453   Session lifecycle: autosave, snapshots, statusline
  L4722   Composer: input buffer, queue, paste/key parsing
  L5284   Version/update precedence + provider registration API
  L5945   Session modes + CLI arg completion + /set + leash + per-model
  L6432   Grouped lean-tools + provider/tool discovery dirs
  L6738   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
