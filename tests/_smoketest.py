...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1601   Config drift guard + queue-drain + host normalization
  L2312   Ollama num_ctx, host failover, per-host models, machines
  L2720   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4018   Session lifecycle: autosave, snapshots, statusline
  L4287   Composer: input buffer, queue, paste/key parsing
  L4844   Version/update precedence + provider registration API
  L5505   Session modes + CLI arg completion + /set + leash + per-model
  L5989   Grouped lean-tools + provider/tool discovery dirs
  L6282   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
