...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1231   Config drift guard + queue-drain + host normalization
  L1912   Ollama num_ctx, host failover, per-host models, machines
  L2320   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3618   Session lifecycle: autosave, snapshots, statusline
  L3887   Composer: input buffer, queue, paste/key parsing
  L4444   Version/update precedence + provider registration API
  L5105   Session modes + CLI arg completion + /set + leash + per-model
  L5589   Grouped lean-tools + provider/tool discovery dirs
  L5882   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
