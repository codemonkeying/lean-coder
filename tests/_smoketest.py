...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1957   Config drift guard + queue-drain + host normalization
  L2849   Ollama num_ctx, host failover, per-host models, machines
  L3257   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4596   Session lifecycle: autosave, snapshots, statusline
  L4865   Composer: input buffer, queue, paste/key parsing
  L5427   Version/update precedence + provider registration API
  L6088   Session modes + CLI arg completion + /set + leash + per-model
  L6575   Grouped lean-tools + provider/tool discovery dirs
  L6881   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
