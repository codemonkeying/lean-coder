...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5236   Version/update precedence + provider registration API
  L5897   Session modes + CLI arg completion + /set + leash + per-model
  L6384   Grouped lean-tools + provider/tool discovery dirs
  L6690   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
