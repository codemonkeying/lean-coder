...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1822   Config drift guard + queue-drain + host normalization
  L2713   Ollama num_ctx, host failover, per-host models, machines
  L3121   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4460   Session lifecycle: autosave, snapshots, statusline
  L4729   Composer: input buffer, queue, paste/key parsing
  L5291   Version/update precedence + provider registration API
  L5952   Session modes + CLI arg completion + /set + leash + per-model
  L6439   Grouped lean-tools + provider/tool discovery dirs
  L6745   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
