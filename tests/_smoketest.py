...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1375   Config drift guard + queue-drain + host normalization
  L2086   Ollama num_ctx, host failover, per-host models, machines
  L2494   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3792   Session lifecycle: autosave, snapshots, statusline
  L4061   Composer: input buffer, queue, paste/key parsing
  L4618   Version/update precedence + provider registration API
  L5279   Session modes + CLI arg completion + /set + leash + per-model
  L5763   Grouped lean-tools + provider/tool discovery dirs
  L6056   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
