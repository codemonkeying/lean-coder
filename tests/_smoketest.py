...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2569   Ollama num_ctx, host failover, per-host models, machines
  L2977   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4275   Session lifecycle: autosave, snapshots, statusline
  L4544   Composer: input buffer, queue, paste/key parsing
  L5101   Version/update precedence + provider registration API
  L5762   Session modes + CLI arg completion + /set + leash + per-model
  L6246   Grouped lean-tools + provider/tool discovery dirs
  L6539   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
