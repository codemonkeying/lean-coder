...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5719   Version/update precedence + provider registration API
  L6389   Session modes + CLI arg completion + /set + leash + per-model
  L6876   Grouped lean-tools + provider/tool discovery dirs
  L7182   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
