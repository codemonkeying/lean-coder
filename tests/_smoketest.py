...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1835   Ollama num_ctx, host failover, per-host models, machines
  L2243   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3507   Session lifecycle: autosave, snapshots, statusline
  L3776   Composer: input buffer, queue, paste/key parsing
  L4333   Version/update precedence + provider registration API
  L4968   Session modes + CLI arg completion + /set + leash + per-model
  L5438   Grouped lean-tools + provider/tool discovery dirs
  L5710   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
