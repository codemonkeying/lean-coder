...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2346   Config drift guard + queue-drain + host normalization
  L3365   Ollama num_ctx, host failover, per-host models, machines
  L3787   Remote executor + SSH transport + RemoteWorkspace + Windows
  L5144   Session lifecycle: autosave, snapshots, statusline
  L5476   Composer: input buffer, queue, paste/key parsing
  L6085   Version/update precedence + provider registration API
  L6760   Session modes + CLI arg completion + /set + leash + per-model
  L7247   Grouped lean-tools + provider/tool discovery dirs
  L7551   Per-process run dirs (liveness reaper, no age)
  L7581   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
