...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1945   Config drift guard + queue-drain + host normalization
  L2837   Ollama num_ctx, host failover, per-host models, machines
  L3245   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4584   Session lifecycle: autosave, snapshots, statusline
  L4853   Composer: input buffer, queue, paste/key parsing
  L5415   Version/update precedence + provider registration API
  L6076   Session modes + CLI arg completion + /set + leash + per-model
  L6563   Grouped lean-tools + provider/tool discovery dirs
  L6869   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
