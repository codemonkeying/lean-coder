...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1673   Config drift guard + queue-drain + host normalization
  L2384   Ollama num_ctx, host failover, per-host models, machines
  L2792   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4090   Session lifecycle: autosave, snapshots, statusline
  L4359   Composer: input buffer, queue, paste/key parsing
  L4916   Version/update precedence + provider registration API
  L5577   Session modes + CLI arg completion + /set + leash + per-model
  L6061   Grouped lean-tools + provider/tool discovery dirs
  L6354   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
