...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1800   Config drift guard + queue-drain + host normalization
  L2654   Ollama num_ctx, host failover, per-host models, machines
  L3062   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4401   Session lifecycle: autosave, snapshots, statusline
  L4670   Composer: input buffer, queue, paste/key parsing
  L5227   Version/update precedence + provider registration API
  L5888   Session modes + CLI arg completion + /set + leash + per-model
  L6375   Grouped lean-tools + provider/tool discovery dirs
  L6681   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
