...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5712   Version/update precedence + provider registration API
  L6382   Session modes + CLI arg completion + /set + leash + per-model
  L6869   Grouped lean-tools + provider/tool discovery dirs
  L7175   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
