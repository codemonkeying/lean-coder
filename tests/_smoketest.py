...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2407   Config drift guard + queue-drain + host normalization
  L3426   Ollama num_ctx, host failover, per-host models, machines
  L3848   Remote executor + SSH transport + RemoteWorkspace + Windows
  L5276   Session lifecycle: autosave, snapshots, statusline
  L5608   Composer: input buffer, queue, paste/key parsing
  L6217   Version/update precedence + provider registration API
  L6892   Session modes + CLI arg completion + /set + leash + per-model
  L7379   Grouped lean-tools + provider/tool discovery dirs
  L7683   Per-process run dirs (liveness reaper, no age)
  L7713   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
