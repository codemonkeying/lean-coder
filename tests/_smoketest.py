...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1660   Config drift guard + queue-drain + host normalization
  L2371   Ollama num_ctx, host failover, per-host models, machines
  L2779   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4077   Session lifecycle: autosave, snapshots, statusline
  L4346   Composer: input buffer, queue, paste/key parsing
  L4903   Version/update precedence + provider registration API
  L5564   Session modes + CLI arg completion + /set + leash + per-model
  L6048   Grouped lean-tools + provider/tool discovery dirs
  L6341   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
