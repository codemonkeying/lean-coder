...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1240   Config drift guard + queue-drain + host normalization
  L1921   Ollama num_ctx, host failover, per-host models, machines
  L2329   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3627   Session lifecycle: autosave, snapshots, statusline
  L3896   Composer: input buffer, queue, paste/key parsing
  L4453   Version/update precedence + provider registration API
  L5114   Session modes + CLI arg completion + /set + leash + per-model
  L5598   Grouped lean-tools + provider/tool discovery dirs
  L5891   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
