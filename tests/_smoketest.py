...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L4379   Session lifecycle: autosave, snapshots, statusline
  L4648   Composer: input buffer, queue, paste/key parsing
  L5205   Version/update precedence + provider registration API
  L5866   Session modes + CLI arg completion + /set + leash + per-model
  L6353   Grouped lean-tools + provider/tool discovery dirs
  L6659   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
