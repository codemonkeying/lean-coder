...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1306   Config drift guard + queue-drain + host normalization
  L1988   Ollama num_ctx, host failover, per-host models, machines
  L2396   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3694   Session lifecycle: autosave, snapshots, statusline
  L3963   Composer: input buffer, queue, paste/key parsing
  L4520   Version/update precedence + provider registration API
  L5181   Session modes + CLI arg completion + /set + leash + per-model
  L5665   Grouped lean-tools + provider/tool discovery dirs
  L5958   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
