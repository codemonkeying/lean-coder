...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2147   Config drift guard + queue-drain + host normalization
  L3040   Ollama num_ctx, host failover, per-host models, machines
  L3462   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4817   Session lifecycle: autosave, snapshots, statusline
  L5136   Composer: input buffer, queue, paste/key parsing
  L5745   Version/update precedence + provider registration API
  L6415   Session modes + CLI arg completion + /set + leash + per-model
  L6902   Grouped lean-tools + provider/tool discovery dirs
  L7208   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
