...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L5163   Session lifecycle: autosave, snapshots, statusline
  L5495   Composer: input buffer, queue, paste/key parsing
  L6104   Version/update precedence + provider registration API
  L6779   Session modes + CLI arg completion + /set + leash + per-model
  L7266   Grouped lean-tools + provider/tool discovery dirs
  L7570   Per-process run dirs (liveness reaper, no age)
  L7600   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
