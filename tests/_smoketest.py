...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L6233   Session modes + CLI arg completion + /set + leash + per-model
  L6720   Grouped lean-tools + provider/tool discovery dirs
  L7026   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
