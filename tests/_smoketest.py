...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1332   Config drift guard + queue-drain + host normalization
  L2042   Ollama num_ctx, host failover, per-host models, machines
  L2450   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3748   Session lifecycle: autosave, snapshots, statusline
  L4017   Composer: input buffer, queue, paste/key parsing
  L4574   Version/update precedence + provider registration API
  L5235   Session modes + CLI arg completion + /set + leash + per-model
  L5719   Grouped lean-tools + provider/tool discovery dirs
  L6012   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
