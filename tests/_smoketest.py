...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2662   Ollama num_ctx, host failover, per-host models, machines
  L3070   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4409   Session lifecycle: autosave, snapshots, statusline
  L4678   Composer: input buffer, queue, paste/key parsing
  L5235   Version/update precedence + provider registration API
  L5896   Session modes + CLI arg completion + /set + leash + per-model
  L6383   Grouped lean-tools + provider/tool discovery dirs
  L6689   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
