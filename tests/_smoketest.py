...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2631   Ollama num_ctx, host failover, per-host models, machines
  L3039   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4356   Session lifecycle: autosave, snapshots, statusline
  L4625   Composer: input buffer, queue, paste/key parsing
  L5182   Version/update precedence + provider registration API
  L5843   Session modes + CLI arg completion + /set + leash + per-model
  L6327   Grouped lean-tools + provider/tool discovery dirs
  L6633   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
