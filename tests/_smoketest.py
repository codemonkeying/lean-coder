...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1528   Config drift guard + queue-drain + host normalization
  L2239   Ollama num_ctx, host failover, per-host models, machines
  L2647   Remote executor + SSH transport + RemoteWorkspace + Windows
  L3945   Session lifecycle: autosave, snapshots, statusline
  L4214   Composer: input buffer, queue, paste/key parsing
  L4771   Version/update precedence + provider registration API
  L5432   Session modes + CLI arg completion + /set + leash + per-model
  L5916   Grouped lean-tools + provider/tool discovery dirs
  L6209   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
