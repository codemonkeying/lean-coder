...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L1709   Config drift guard + queue-drain + host normalization
  L2420   Ollama num_ctx, host failover, per-host models, machines
  L2828   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4126   Session lifecycle: autosave, snapshots, statusline
  L4395   Composer: input buffer, queue, paste/key parsing
  L4952   Version/update precedence + provider registration API
  L5613   Session modes + CLI arg completion + /set + leash + per-model
  L6097   Grouped lean-tools + provider/tool discovery dirs
  L6390   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
