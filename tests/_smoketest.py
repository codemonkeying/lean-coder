...
=== FILE MAP (regen: tools/gen_section_index.py) ===
  ...
  L2021   Config drift guard + queue-drain + host normalization
  L2913   Ollama num_ctx, host failover, per-host models, machines
  L3321   Remote executor + SSH transport + RemoteWorkspace + Windows
  L4660   Session lifecycle: autosave, snapshots, statusline
  L4929   Composer: input buffer, queue, paste/key parsing
  L5491   Version/update precedence + provider registration API
  L6152   Session modes + CLI arg completion + /set + leash + per-model
  L6639   Grouped lean-tools + provider/tool discovery dirs
  L6945   Hygiene sweep + FILE MAP drift gate (final gates)
=== END FILE MAP ===
"""
